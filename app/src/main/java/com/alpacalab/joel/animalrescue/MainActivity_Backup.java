...
public class MainActivity_Backup extends ActionBarActivity implements AdapterView.OnItemClickListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_main_backup, menu);
        return true;
    }
